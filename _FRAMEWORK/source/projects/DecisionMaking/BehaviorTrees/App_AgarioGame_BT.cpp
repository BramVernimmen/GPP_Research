...
void App_AgarioGame_BT::Start()
{
	...
	BehaviorTree* pBehaviorTree = new BehaviorTree(pBlackboard,
		new BehaviorSelector(
			{
			// Try to avoid bigger agents
				new BehaviorSequence(
				{
					new BehaviorConditional(BT_Conditions::IsBiggerAgentNearby),
					new BehaviorAction(BT_Actions::ChangeToEvadeBigger)
				}), 
			// Try to pursue smaller agents
				new BehaviorSequence(
				{
					new BehaviorConditional(BT_Conditions::IsSmallerAgentNearby),
					new BehaviorAction(BT_Actions::ChangeToPursueSmaller)
				}),
			// Try to seek food
				new BehaviorSequence(
				{
...
Blackboard* App_AgarioGame_BT::CreateBlackboard(AgarioAgent* a)
{
	...
	pBlackboard->AddData("AgentPursueTarget", static_cast<AgarioAgent*>(nullptr)); // Needs the cast for the type
